...
function getGridPropertiesAndEventsJs() {
    const {ComponentUtil} = require("@ptsecurity/native-grid");
...
function getGridColumnPropertiesJs() {
    const {ColDefUtil} = require("@ptsecurity/native-grid");
...
function getGridPropertiesAndEventsTs() {
    const eventsSrc = getJavascript('./node_modules/@ptsecurity/native-grid/src/ts/eventKeys.ts');
    const propertyKeysSrc = getJavascript('./node_modules/@ptsecurity/native-grid/src/ts/propertyKeys.ts');
...
function getGridColumnPropertiesTs() {
    const js = getJavascript('./node_modules/@ptsecurity/native-grid/src/ts/components/colDefUtil.ts');
    eval(js);
